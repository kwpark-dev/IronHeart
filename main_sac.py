...
from player.sac import AgentSAC, ReplayBuffer
...
if __name__ == "__main__":
    ...
    for _ in tqdm(range(EPISODE)):
        ...
        while True:
            action, _ = agent.action(state.unsqueeze(0))
            next_state, reward, done, trun, _ = env.step(action.squeeze().numpy())    
    ...
    fig.suptitle(name)
    # plt.savefig('./images/sac/{}_gam_0{}.jpg'.format(name, 
